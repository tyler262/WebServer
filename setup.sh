...
echo ""
echo "3. TV ADB Setup (do this once per TV, using your TV remote):"
echo "   a. Settings > Device Preferences > About"
echo "      Press OK on 'Build' 7 times to unlock Developer Options"
echo "   b. Settings > Device Preferences > Developer Options"
echo "      Enable 'USB debugging'"
echo "   c. Find TV IP: Settings > Network > Status"
echo "   d. On the Pi, run: adb connect <TV_IP>:5555"
echo "      A dialog appears on the TV — navigate to it with your remote and select OK"
echo ""
